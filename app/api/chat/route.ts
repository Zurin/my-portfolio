...
const createContextFromData = () => {
  ...
  return `
    ...
    - Golang: Building high-performance, scalable, microservice backend
    - 3rd Party Apps Integration: Implementing apps integration through partners API
  ...
  try {
    ...
    const chat = model.startChat({
      history: [
        {
          role: "user",
          parts: `You are an AI assistant for Rino Ridlo. Use the following information to help answer questions:
            ...
            - Focus on Rino's expertise in Next.js, Golang, Laravel, and API Integration`,
        },
        {
          role: "model",
          parts:
